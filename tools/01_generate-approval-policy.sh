...
# ==============================================================================
#
# Applies the Planton Cloud McpServer YAML (triggering auto-discovery of
...
#
# The mcp-server-creator agent queries the backend for the planton-cloud
# MCP server's discovered tools and determines which operations need human
# approval based on the nature of each tool.
#
# Prerequisites:
#   - stigmer CLI in PATH
#   - mcp-servers/planton-cloud.yaml exists (from 00_onboard-planton-mcp-server.sh)
...
readonly MCP_SERVER_YAML="${OUTPUT_DIR}/planton-cloud.yaml"
...
Generate an updated planton-cloud McpServer YAML with default_tool_approvals.

Look up the discovered capabilities of the planton-cloud MCP server.
